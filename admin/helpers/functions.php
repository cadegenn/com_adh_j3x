...
abstract class ADHFunctions {
	...
	function escapeString($string) {
		...
		//$string = ADHFunctions::unEscapeString($string);
		//stripslashes($string);
		...
		// PHP >= 5.4
		//$string = htmlentities(ADHFunctions::br2nl($string), ENT_QUOTES | ENT_SUBSTITUTE | ENT_DISALLOWED | ENT_HTML5, 'UTF-8');
		// PHP <= 5.3
		$string = htmlentities(ADHFunctions::br2nl($string), ENT_QUOTES);//, 'UTF-8');
		return $string;
	}

	/**
	 * @brief	Décode correctement les chaines converties avec ADHFunctions::escapeString
	 * 
	 * @param	string	La chaine a traiter
	 * @return	string	La chaine convertie
	 */
