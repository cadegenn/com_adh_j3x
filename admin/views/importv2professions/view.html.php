 ...
 * adh View
 */
class adhViewImportV2Professions extends JViewLegacy
{
	/**
	...
	{
		if ($this->_models['importv2professions']->_db->getErrorNum() > 0) { 
			$items = "";
		} else {
			$items = $this->get('Items');			// => admin/models/importV2professions.php
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_ADH').' : '.JText::_('COM_ADH_SUBMENU_IMPORT_PROFESSIONS'), 'adh');
		...
		JToolBarHelper::custom('importV2Professions.import','import','import',JText::_('COM_ADH_IMPORT'), true);
