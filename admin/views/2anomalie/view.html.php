 ...
 * 
 */
class adhView2anomalie extends JViewLegacy
{
	/**
    ...
    protected function addToolBar() 
    {
        ...
        //JToolBarHelper::apply('2anomalie.apply');                                   // --> administrator/components/com_adh/controllers/2anomalie.php::save();
        //JToolBarHelper::save('2anomalie.save');                                     // --> administrator/components/com_adh/controllers/2anomalie.php::save();
        //JToolBarHelper::save2new('2anomalie.save2new');								// --> administrator/components/com_adh/controllers/2anomalie.php::save();
        //JToolBarHelper::save2copy('2anomalie.save2copy');                           // --> administrator/components/com_adh/controllers/2anomalie.php::save();
        JToolBarHelper::cancel('2anomalie.cancel', 'JTOOLBAR_CLOSE');				// --> administrator/components/com_adh/controllers/2anomalie.php::cancel();
    }
	...
	public function addUserToolbar($name = "") {
		...
		AdhToolBarHelper::apply('2anomalie.apply', 'JAPPLY', 'toolbar-'.$name, 'adminForm'.  ucwords($name));
		//return $toolbar;
	}
