 ...
 * adh View
 */
class adhViewConfig extends JViewLegacy
{
	/**
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_ADH').' : '.JText::_('COM_ADH_SUBMENU_CONFIG'), 'adh');
		//JToolBarHelper::custom('config.config','config','config',JText::_('COM_ADH_CONFIG'), true);
